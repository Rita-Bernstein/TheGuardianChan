...
import TheGuardianChan.patches.SlimeAttachPoints;
...
public abstract class SpawnedSlime
    ...
    private static Map<String, String> atlasMap;
    ...
    static
    {
        ...
        atlasMap.put("Slimebound:AttackSlime",                  "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_S.atlas");
        atlasMap.put("Slimebound:BronzeSlime",                  "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_M.atlas");
        atlasMap.put("Slimebound:CultistSlime",                 "TheGuardianChan/monsters/TheSlimeBossWaifu/orbs/Slime_CultistSlime.atlas");
        atlasMap.put("Slimebound:GreedOozeSlime",               "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_acid_S.atlas");
        atlasMap.put("Slimebound:HexSlime",                     "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_M.atlas");
        atlasMap.put("Slimebound:PoisonSlime",                  "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_acid_S.atlas");
        atlasMap.put("Slimebound:ScrapOozeSlime",               "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_S.atlas");
        atlasMap.put("Slimebound:ShieldSlime",                  "TheGuardianChan/monsters/TheSlimeBossWaifu/orbs/Slime_ShieldSlime.atlas");
        atlasMap.put("Slimebound:SlimingSlime",                 "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_S.atlas");
        atlasMap.put("Slimebound:TorchHeadSlime",               "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_M.atlas");

        jsonMap.put("Slimebound:AttackSlime",                   "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_S.json");
        jsonMap.put("Slimebound:BronzeSlime",                   "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_M.json");
        jsonMap.put("Slimebound:CultistSlime",                  "TheGuardianChan/monsters/TheSlimeBossWaifu/orbs/Slime_CultistSlime.json");//变更
        jsonMap.put("Slimebound:GreedOozeSlime",                "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_acid_S.json");
        jsonMap.put("Slimebound:HexSlime",                      "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_M.json");
        jsonMap.put("Slimebound:PoisonSlime",                   "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_acid_S.json");
        jsonMap.put("Slimebound:ScrapOozeSlime",                "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_S.json");
        jsonMap.put("Slimebound:ShieldSlime",                   "TheGuardianChan/monsters/TheSlimeBossWaifu/orbs/Slime_ShieldSlime.json");
        jsonMap.put("Slimebound:SlimingSlime",                  "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_S.json");
        jsonMap.put("Slimebound:TorchHeadSlime",                "TheGuardianChan/monsters/TheSlimeBossWaifu/Slime_spike_M.json");


        modelColorMap.put("Slimebound:AttackSlime",             new Color(0.8F,0.25F,0.25F,2F));
        modelColorMap.put("Slimebound:BronzeSlime",             new Color(1F,150F/255F,0F,2F));
        modelColorMap.put("Slimebound:CultistSlime",            Color.WHITE);//变更
        modelColorMap.put("Slimebound:GreedOozeSlime",          new Color(1F,1F,30F/255F,2F));
        modelColorMap.put("Slimebound:HexSlime",                new Color(240F/255F,236/255F,150F/255F,2F));
        modelColorMap.put("Slimebound:PoisonSlime",             new Color(0.6F,.9F,.6F,2F));
        modelColorMap.put("Slimebound:ScrapOozeSlime",          new Color(0.8F,0.4F,0.4F,2F));
        modelColorMap.put("Slimebound:ShieldSlime",             Color.WHITE);
        modelColorMap.put("Slimebound:SlimingSlime",            new Color(224F/255F,113F/255F,224F/255F,2F));
        modelColorMap.put("Slimebound:TorchHeadSlime",          new Color(0.75F,0.75F,0.75F,2F));
    ...
    public SpawnedSlime(String ID, int yOffset, Color projectileColor, String atlasString, String skeletonString, String animString, float scale, Color modelColor, int passive, int initialBoost, boolean movesToAttack, Color deathColor, SlimeFlareEffect.OrbFlareColor OrbFlareColor, Texture intentImage, String IMGURL) {
        ...
        if(TheGuardianChan.SlimeOriginalAnimation){
            ...
            this.atlas = new TextureAtlas(Gdx.files.internal(atlasMap.get(ID)));
        }
        ...
        if(TheGuardianChan.SlimeOriginalAnimation){
            ...
            skeletonData = json.readSkeletonData(Gdx.files.internal(jsonMap.get(ID)));
        }
