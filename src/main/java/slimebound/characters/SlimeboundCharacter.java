...
public class SlimeboundCharacter extends CustomPlayer {
    ...
    public float hatX;
    public float hatY;
    public float animationScaleX;
    public float animationScaleY;
    ...
    private String atlasURL2 = "TheGuardianChan/monsters/TheSlimeBossWaifu/char/Slime_acid_char.atlas";
    private String atlasURLPuddle2 = "TheGuardianChan/monsters/TheSlimeBossWaifu/char/Slime_acid_char_puddle.atlas";

    private String jsonURL2 = "TheGuardianChan/monsters/TheSlimeBossWaifu/char/Slime_acid_char.json";
    ...
    public void render(SpriteBatch sb) {
        ...
        if(!SlimeOriginalAnimation){
            this.animationScaleX =  this.skeleton.findBone("scale_center").getScaleX() * this.skeleton.findBone("root").getScaleX();
            this.animationScaleY =  this.skeleton.findBone("scale_center").getScaleY() * this.skeleton.findBone("root").getScaleY();

            this.hatX = (this.skeleton.findBone("eyeback1").getX() + this.skeleton.findBone("body").getX() + this.skeleton.findBone("scale_center").getX() ) * this.animationScaleX ;
            this.hatY = (this.skeleton.findBone("eyeback1").getY() + this.skeleton.findBone("body").getY() + this.skeleton.findBone("scale_center").getY() ) * this.animationScaleY ;
        }else {
